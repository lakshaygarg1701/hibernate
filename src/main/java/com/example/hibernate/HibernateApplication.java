...
public class HibernateApplication {
	...
	CommandLineRunner runner(Service service){
		return args -> {
//			service.insertRole(new RolesHibernateEntity("ADM","Admin"));
//			service.insertRole(new RolesHibernateEntity("USR","User"));
//			service.insertRole(new RolesHibernateEntity("SU","Super_User"));
//			service.insertRole(new RolesHibernateEntity("MGR","Manager"));
...
//			service.getRolesForUser("lg17881");
//			service.getRolesForUser("pc89589");
//			service.getRolesForUser("ak98558");
//			service.getRolesForUser("nn98432");
//			service.getRolesForUser("gm22214");
